...
exports.getAppSyncConfig = exports.isPipelineResolver = exports.isUnitResolver = void 0;
...
var getAppSyncConfig = function (config) {
    ...
    (0, lodash_1.forEach)(flattenMaps(config.resolvers), function (resolver, typeAndField) {
        ...
        // @ts-ignore
        if ((0, exports.isUnitResolver)(resolver) && typeof resolver.dataSource === 'object') {
            var name_1 = typeAndField.replace(/[^a-z_]/i, '_');
            dataSources[name_1] = __assign(__assign({}, resolver.dataSource), { name: name_1 });
        }
        resolvers[typeAndField] = __assign(__assign(__assign({}, resolver), { type: resolver.type || type, field: resolver.field || field }), ((0, exports.isUnitResolver)(resolver)
            ? {
                kind: 'UNIT',
                dataSource: 
                // @ts-ignore
