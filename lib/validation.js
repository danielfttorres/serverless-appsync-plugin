...
exports.AppSyncValidationError = exports.validateConfig = exports.appSyncSchema = void 0;
var ajv_1 = __importDefault(require("ajv"));
var ajv_errors_1 = __importDefault(require("ajv-errors"));
var ajv_merge_patch_1 = __importDefault(require("ajv-merge-patch"));
        ...
        auth: {
            ...
            properties: {
                type: {
                    type: 'string',
                    enum: AUTH_TYPES,
                    errorMessage: "must be one of ".concat(AUTH_TYPES.join(', ')),
                },
            },
            ...
            additionalProperties: {
                ...
                errorMessage: {
                    required: {
                        ...
                        field: 'resolver definitions that do not specify Type.field in the key must specify the type and field as properties',
                    },
                },
            },
            required: [],
        ...
        dataSourceConfig: {
            ...
            properties: {
                type: {
                    ...
                    errorMessage: "must be one of ".concat(DATASOURCE_TYPES.join(', ')),
                },
                description: { type: 'string' },
            },
        ...
        domain: {
            ...
            properties: {
                ...
                hostedZoneName: {
                    type: 'string',
                    pattern: '^([a-z][a-z0-9+-]*\\.)+[a-z][a-z0-9]*\\.$',
                    errorMessage: 'must be a valid zone name. Note: you must include a trailing dot (eg: `example.com.`)',
                },
            ...
            then: {
                ...
                errorMessage: 'when using CloudFormation, you must provide either certificateArn or hostedZoneId.',
            },
        },
        ...
        caching: {
            ...
            properties: {
                ...
                behavior: {
                    ...
                    errorMessage: "must be one of 'FULL_REQUEST_CACHING', 'PER_RESOLVER_CACHING'",
                },
                type: {
                    enum: [
                        'SMALL',
                    ...
                    errorMessage: "must be one of 'SMALL', 'MEDIUM', 'LARGE', 'XLARGE', 'LARGE_2X', 'LARGE_4X', 'LARGE_8X', 'LARGE_12X'",
                },
                ttl: { type: 'integer', minimum: 1, maximum: 3600 },
            ...
            items: {
                ...
                then: {
                    ...
                    properties: {
                        ...
                        expiresAfter: {
                            type: ['string', 'number'],
                            pattern: "^(\\d+)(".concat(Object.keys(utils_1.timeUnits).join('|'), ")?$"),
...
var ajv = new ajv_1.default({ allErrors: true, allowUnionTypes: true });
(0, ajv_merge_patch_1.default)(ajv);
(0, ajv_errors_1.default)(ajv);
(0, ajv_formats_1.default)(ajv);
var validator = ajv.compile(exports.appSyncSchema);
var validateConfig = function (data) {
    var isValid = validator(data);
    if (isValid === false && validator.errors) {
        throw new AppSyncValidationError(validator.errors
            .filter(function (error) {
            return !['if', 'oneOf', 'anyOf', '$merge'].includes(error.keyword);
        })
            .map(function (error) {
            return {
...
var AppSyncValidationError = /** @class */ (function (_super) {
    __extends(AppSyncValidationError, _super);
    function AppSyncValidationError(validationErrors) {
        var _this = _super.call(this, validationErrors
            .map(function (error) { return "".concat(error.path, ": ").concat(error.message); })
            .join('\n')) || this;
        _this.validationErrors = validationErrors;
        Object.setPrototypeOf(_this, AppSyncValidationError.prototype);
        return _this;
    }
    return AppSyncValidationError;
}(Error));
exports.AppSyncValidationError = AppSyncValidationError;
